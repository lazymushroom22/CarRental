      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1 style="color:#1825a9 ;">Find your favorite car.</h1>
            <p style="color:red;">We provide the finest vehicles from the best brands only for you. </p>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Find the best car to your liking.</h2>
      <p>Welcome to our Car Rental website. Here you can see all of our new cars that you can rent right now! Quality is assured. Just select one of the cars below and complete the form!</p>
    </div>
    <div class="row"> 
